<div id="floater_innerwrap">
    <div id="floater_handle">
        <span id="floater_title"><?php echo $this->kga['lang']['export_extension']['exportJSON'] ?></span>
        <div class="right">
    ...
    <div class="floater_content">
        <form id="export_extension_form_export_JSON" action="../extensions/ki_export/processor.php" method="post">
            <!-- <input type="hidden" name="id" value="" /> -->
            <input type="hidden" name="axAction" value="export_json"/>
