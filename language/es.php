...
return array(
    ...
    "def_pctID" => "ID de proyecto predeterminado",
    "def_kndID" => "ID de cliente predeterminado",
    "def_evtID" => "ID de evento predeterminado",
    ...
    "new_knd" => "agregar cliente",
    "new_pct" => "agregar proyecto",
    ...
    "editusr" => "Editar usuario",
    "editgrp" => "Editar grupo",
    "delgrp" => "Borrar grupo",
    "delpct" => "Borrar proyecto",
    "delknd" => "Borrar cliente",
    "delevt" => "Borrar tarea",
    "switchusr" => "Cambiar a este usuario",
    "backupusr" => "Hacer copia de seguridad de este usuario",
    "mailusr" => "Enviar email a este usuario",
    "delusr" => "Eliminar este usuario",
    "bannedusr" => "Usuario baneado - click para reactivarlo",
    "activeusr" => "usuario activo - click para banearlo",
    ...
    "flip_pct_display" => "Ordenar la tabla de proyectos por clientes",
    "pct_comment_flag" => "Siempre ver comentarios junto a proyectos",
    "showIDs" => "Ver IDs",
    "error" => "Ha ocurrido un error.",
    "checkupdate" => "Comprobar actualizaciones",

    "selectR" => "Seleccionado para grabar:",
    "selectKND" => "C:",
    "selectPCT" => "P:",
    "selectEVT" => "T:",
    ...
    'exactSums' => 'Usar totales exactos en lugar de sumar los valores redondeados.',
