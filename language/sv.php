...
/**
 * Swedish - Svenska
 * Based on Kimai english version 0.9.1.1138
 * By Conny Sjölund
...
return array(
    ...
    "mins" => "minuter",
    "secs" => "sekunder",
    "skin" => "Gränssnitt (skin)",
    "erase" => "Radera Post",
    "new_customer" => "lägg till kund",
    "new_project" => "lägg till projekt",
    ...
    "wrongPass" => "Fel Anvandarnamn och/eller Lösenord",
    "tryAgain" => "Försök igen / glömt lösenord",
    "back" => "Tillbaka till inloggningsfönstret",
    "bye" => "Hej då!",
    "login" => "Logga in",
    "logout" => "Logga ut",
    "loggedon" => "Inloggad som användare:",
    ...
    "delete_activity" => "radera uppgift",
    "switchUser" => "Växla till denna användare",
    "backupUser" => "Skapa en backup av denna användare",
    "mailUser" => "Skicka ett mejl till denna användare",
    "deleteUser" => "Radera denna användare",
    "bannedUser" => "Bannlyst användare - klicka för att återaktivera",
    "activeAccount" => "Aktiv användare - klicka för att bannlysa",
    "members" => "Medlemmar",
    ...
    "help" => "Hjälp",
    "select" => "Välj",
    "hidedeletedusers" => "Göm valda användare",
    "showdeletedusers" => "Visa raderade användare",
    ...
    "commentType" => "Kommentarens typ",
    "ctype0" => "Kommentar",
    "ctype1" => "Notering",
    "ctype2" => "Varning!",
    "hint" => "Tips:",
    "rename_caution_before_username" => "Om du ändrar användarnamn på",
    "rename_caution_after_username" => "du måste logga in på nytt med ditt nya användarnamn omedelbart!",
    "timediff_warn" => "Du måste ange olika tider i fälten in/ut!",
    "visibility" => "Synlighet",
    "showitem" => "gör synlig",
    "hideitem" => "gör osynlig",
    "checkUsername" => "Du måste skriva in ett användarnamn i fältet till vänster om lägg till knappen!",
    "clickToReload" => "Klicka här för att ladda om GUI",
    "sure" => "Säker?",
    "clock" => "Klocka",
    "currSum" => "Sammanfattning av aktuell tidsperiod",
    "admWarn" => "Du är Admin. Status kan endast sättas lägre av annan Admin.",
    "flip_project_display" => "Ordna projekttabell enligt kunder",
    "project_comment_flag" => "Visa alltid kommentarer bredvid projekt",
    "showIDs" => "Visa ID:n",
    "error" => "Ett fel har uppstått!",
    "checkupdate" => "Leta efter uppdatering",

    "selectedForRecording" => "Valt för registrering:",
    "selectedCustomerLabel" => "K:",
    "selectedProjectLabel" => "P:",
    "selectedActivityLabel" => "T:",

    "testCustomer" => "Test-Kund",
    ...
    "rate" => "Pris (per timme)",
    "rate_short" => "Pris",
    "default_rate" => "Standard pris",
    "my_rate" => "Mitt pris",

    "wage" => "Arvode",

    "customerlogin" => "kundinloggning",
...
Choose another table prefix or delete existing tables with this prefix in order to allow Kimai to perform a clean installation.')
    ...
    'export_extension' => array(
        ...
        "cleared_all" => "alla",
        "cleared_cleared" => "endast kvitterade",
        "cleared_open" => "endast öppna",
        "stdrd_location" => "Standard-Plats",
        "timeformat" => "Tidsformat",
        "dateformat" => "Datumformat",

        "print_comment" => "skriv kommentarer",
        "print_summary" => "skriv sammandrag",
        "create_bookmarks" => "skapa bokmärken",
        "download_pdf" => "ladda ner som PDF",
        "pdf_format" => "format",
        "export_pdf" => "tabell",
        "export_pdf2" => "lista",

        "column_delimiter" => "avgränsare för kolumner",
        ...
        'subtotal' => 'Delsumma',
        'finalamount' => 'Totalt',
        'pdf_headline' => 'Lista på arbetstid och utlägg',
        'costs' => 'Kostnad',
        'expense' => 'Utlägg',
        'summary' => 'Sammandrag',
        'full_list' => 'Full List',
